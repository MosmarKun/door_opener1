...
class _DeviceWithAvailability extends BluetoothDevice {
  ...
  _DeviceWithAvailability({ required this.rssi, required this.availability, required this.device}) : super(address: "");
}
        ...
        devices = bondedDevices
            .map(
              (device) => _DeviceWithAvailability(
                device:device,
                availability: widget.checkAvailability ? _DeviceAvailability.maybe : _DeviceAvailability.yes,
                rssi: 1
              ),
            )
            .toList();
